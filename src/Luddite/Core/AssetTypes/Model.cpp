...
void ModelLibrary::Initialize()
{
        ...
        m_Extensions.emplace(L".3d");
        m_Extensions.emplace(L".3ds");
        m_Extensions.emplace(L".3mf");
        m_Extensions.emplace(L".ac");
        m_Extensions.emplace(L".ac3d");
        m_Extensions.emplace(L".acc");
        m_Extensions.emplace(L".amj");
        m_Extensions.emplace(L".ase");
        m_Extensions.emplace(L".ask");
        m_Extensions.emplace(L".b3d");
        m_Extensions.emplace(L".blend");
        m_Extensions.emplace(L".bvh");
        m_Extensions.emplace(L".cms");
        m_Extensions.emplace(L".cob");
        m_Extensions.emplace(L".dae");
        m_Extensions.emplace(L".dxf");
        m_Extensions.emplace(L".enff");
        m_Extensions.emplace(L".fbx");
        m_Extensions.emplace(L".gltf");
        m_Extensions.emplace(L".hmb");
        m_Extensions.emplace(L".ifc-step");
        m_Extensions.emplace(L".irr");
        m_Extensions.emplace(L".irrmesh");
        m_Extensions.emplace(L".lwo");
        m_Extensions.emplace(L".lws");
        m_Extensions.emplace(L".lxo");
        m_Extensions.emplace(L".m3d");
        m_Extensions.emplace(L".md2");
        m_Extensions.emplace(L".md3");
        m_Extensions.emplace(L".md5");
        m_Extensions.emplace(L".mdc");
        m_Extensions.emplace(L".mdl");
        m_Extensions.emplace(L".mesh");
        m_Extensions.emplace(L".mot");
        m_Extensions.emplace(L".ms3d");
        m_Extensions.emplace(L".ndo");
        m_Extensions.emplace(L".nff");
        m_Extensions.emplace(L".obj");
        m_Extensions.emplace(L".off");
        m_Extensions.emplace(L".ogex");
        m_Extensions.emplace(L".ply");
        m_Extensions.emplace(L".pmx");
        m_Extensions.emplace(L".prj");
        m_Extensions.emplace(L".q3o");
        m_Extensions.emplace(L".q3s");
        m_Extensions.emplace(L".raw");
        m_Extensions.emplace(L".scn");
        m_Extensions.emplace(L".sib");
        m_Extensions.emplace(L".smd");
        m_Extensions.emplace(L".stp");
        m_Extensions.emplace(L".stl");
        m_Extensions.emplace(L".ter");
        m_Extensions.emplace(L".uc");
        m_Extensions.emplace(L".vta");
        m_Extensions.emplace(L".x");
        m_Extensions.emplace(L".x3d");
        m_Extensions.emplace(L".xgl");
